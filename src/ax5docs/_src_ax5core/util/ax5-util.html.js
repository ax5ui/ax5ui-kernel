        ...
        "getContent": function(__layoutHelper) {
          ...
          __tag(out,
            ...
            function(out) {
              ...
              out.w('\n            <p>\n                Javascript object type name is not clear. so <code>util.getType</code> method very useful.\n            </p>\n        </section>\n\n        \n        <section class="ax5docs-section">\n            <h2 data-method>ax5.util.is(Type)</h2>\n\n            <p>\n                Return argument object type is [type] result.\n            </p>\n            ');
              __tag(out,
                ______assets_components_ax5docs_js_renderer_js,
                {},
                function(out) {
              ...
              out.w('\n        </section>\n\n        \n        <section class="ax5docs-section">\n            <h2>ax5.util.first</h2>\n\n            <p>\n                It returns the first element in the Array, or Object. However, it is faster to use Array in the "Array\n                [0]"\n                rather than using the "first" method.\n            </p>\n            ');
              __tag(out,
                ______assets_components_ax5docs_js_renderer_js,
                {},
                function(out) {
              ...
              out.w('\n        </section>\n\n        \n        <section class="ax5docs-section">\n            <h2>ax5.util.right</h2>\n\n            <p>\n                Returns. Up from the end of the string index, up to a certain character in a string from the end of the\n                string\n            </p>\n            ');
              __tag(out,
                ______assets_components_ax5docs_js_renderer_js,
                {},
                function(out) {
              ...
              out.w('\n        </section>\n\n        \n        <section class="ax5docs-section">\n            <h2>ax5.util.toArray</h2>\n\n            <p>\n                "nodelist" or on the Array Like such "arguments", has properties such as "length", but you can not use\n                functions\n                defined in Array.prototype. With "toArray" because it is easy to convert an array.\n            </p>\n            ');
              __tag(out,
                ______assets_components_ax5docs_js_renderer_js,
                {},
                function(out) {
