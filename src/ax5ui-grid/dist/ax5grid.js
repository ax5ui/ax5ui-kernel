...
(function (root) {
    ...
    var scrollMover = {
        ...
        "off": function off() {
            ...
            jQuery(document.body).unbind(root.util.ENM["mousemove"] + ".ax5grid-" + this.instanceId).unbind(root.util.ENM["mouseup"] + ".ax5grid-" + this.instanceId).unbind("mouseleave.ax5grid-" + this.instanceId);
    ...
    var init = function init() {
        ...
        this.$["scroller"]["vertical-bar"].bind(root.util.ENM["mousedown"], function (e) {
        ...
        this.$["scroller"]["vertical"].bind("click", function (e) {}.bind(this));

        this.$["scroller"]["horizontal-bar"].bind(root.util.ENM["mousedown"], function (e) {
            this.xvar.mousePosition = root.util.getMousePosition(e);
        ...
        this.$["scroller"]["horizontal"].bind("click", function (e) {}.bind(this));
    };
